...
function example1(){
	...
	imageExample1.load("./static/img/foto_02.jpg", function(){
...
function exampleFilters(){
	...
	imageExampleFilters.load("./static/img/example2.jpg", function(){
...
function exampleAutoCrop(){
	...
	imageAutoCrop.load("./static/img/cheetah.jpg", function(){
...
function clickExampleFiltersChangePixels(){
	// todo 
}
